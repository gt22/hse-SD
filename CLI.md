...
В случае передачи больше, чем одного аргумента или в случае передачи в качестве пути не папки, возвращает ошибку. 
Обновляет значение `workingDirectoryAbsolutePath` (текущей рабочей папки) в `shell`.
